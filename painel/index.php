<html>
    ...
    <body>
        ...
        <section id="home">
            ...
            <a id="reserve-button" class="button blue regular" href="#login" parent="#home">reservar</a>
            <a id="how-works" class="link small gray medium" href="#" parent="#home">como funciona?</a>
        </section>
        ...
        <section id="login">
            ...
            <span class="semibold small gray">Não tenho um cadastro. <a class="bold blue" href="#register" parent="#login">Quero me cadastrar.</a></span>
            <a id="back-home-button" href="#home" parent="#login" class="button gray regular">voltar</a>
        </section>
        ...
        <section id="register">
            ...
            <span class="semibold small gray">Já tenho uma conta. <a class="bold blue" href="#login" parent="#register">Quero fazer o login.</a></span>
            <a id="back-home-button" href="#home" parent="#register" class="button gray regular">voltar</a>
        </section>
    </body>
